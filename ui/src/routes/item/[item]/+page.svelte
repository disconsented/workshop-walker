...
{:then item}
	...
	{:else}
		...
		<!--				<div class="&lt;!&ndash;md:grid-cols-3&ndash;&gt; grid grid-cols-1 gap-8">-->
		<!--					&lt;!&ndash; Main Info Column &ndash;&gt;-->
		<!--					<div class="space-y-6 md:col-span-2">-->
		<!--						&lt;!&ndash; Title and Author &ndash;&gt;-->
		<!--						{@render titleCard()}-->
		<!--						<Accordion-->
		<!--							value={openPanels}-->
