...
RUN ls -lah /usr/src/workshop-walker/ && ls -lah /usr/src/workshop-walker/ui/build

FROM  gcr.io/distroless/cc-debian12:latest
COPY --from=build  /usr/src/workshop-walker/target/release/workshop-walker /
COPY --from=build /usr/src/workshop-walker/ui/build/ /ui/build/
CMD ["./workshop-walker"]